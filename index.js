...
async function run() {
    try {
        ...
        const phonesCollection = client.db('productDB').collection('products');;


        app.get('/phones', async (req, res) => {
    // const { img, name, seller, ratings, price, category } = product;

            const brand = req.query.seller; // Get brand from query params
            const category = req.query.category; // Get category from query params
            const name = req.query.name; // Get category from query params
